...
const greetingCards = [
  {
    ...
    content: 'Another year older, another year closer to hockey greatness! May your birthday be filled with perfect passes, clutch goals, and championship moments. Keep skating toward your dreams!',
    emoji: '🎂',
  ...
  },
  {
    id: 'good-luck-game',
    title: 'Game Day Luck',
    content: 'The ice is calling and you\'re ready to answer! Trust your training, play with heart, and remember - champions are made in moments like these. Good luck out there!',
    emoji: '🍀',
  ...
  },
  {
    ...
    content: 'What an incredible performance! Your hard work, dedication, and team spirit paid off in the best way possible. Congratulations on your well-deserved victory!',
    emoji: '🏆',
  ...
  },
  {
    ...
    content: 'Wishing you a holiday season filled with the joy of hockey - the thrill of the game, the warmth of teammates, and the magic of winter ice. Happy holidays from our hockey family to yours!',
    emoji: '🎄',
...
export default function ShopClient() {
  ...
  return (
    <PageLayout>
            ...
            <div className="space-y-6 z-20 relative text-center lg:text-left">
              ...
              <div className="space-y-3 text-lg md:text-xl text-[#a0aec0] max-w-lg">
                ...
                <div className="flex items-start space-x-3 justify-center lg:justify-start">
                  ...
                  <span className="whitespace-nowrap">Hockey-themed greeting cards</span>
                </div>
                <div className="flex items-start space-x-3 justify-center lg:justify-start">
                  <span className="text-[#4cc9f0] mt-2">•</span>
                  <span className="whitespace-nowrap">Perfect for birthdays and celebrations</span>
                </div>
                <div className="flex items-start space-x-3 justify-center lg:justify-start">
                  <span className="text-[#4cc9f0] mt-2">•</span>
                  <span className="whitespace-nowrap">Share the hockey spirit with loved ones</span>
                </div>
              </div>
      ...
      {/* Greeting Cards Grid */}
      <div id="cards-grid" className="py-16 md:py-20 px-4 md:px-6 bg-[#16213e]/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#a0aec0] max-w-2xl mx-auto">
              Spread hockey love with our specially crafted greeting cards for every occasion
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {greetingCards.map((card) => (
              <div key={card.id} className="bg-[#16213e] hover:bg-[#1e2a4a] rounded-2xl p-8 pt-8 pb-20 transition-all duration-300 hover:scale-105 cursor-pointer group relative">
