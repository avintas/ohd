          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="text-[#a0aec0] leading-relaxed space-y-2 list-disc list-inside">
                ...
                <li>
                  ...
                  interact with our content, sharing patterns, and browsing
                  behavior.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-[#a0aec0] leading-relaxed space-y-2 list-disc list-inside">
                ...
                <li>
                  ...
                  the event of a merger or acquisition of OnlyHockey.com.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-[#a0aec0] leading-relaxed">
                ...
                remember your preferences. You can control cookie settings in
                your browser.
              </p>
            </div>
          </div>
