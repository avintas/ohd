...
export default function MotivateClient({
  motivateMessages,
}: MotivateClientProps) {
            ...
            <div className="space-y-6 z-20 relative text-center lg:text-left">
              ...
              <div className="pt-6">
                <button
                  onClick={() => {
                    document
                      .getElementById('motivation-section')
                      ?.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start',
                      });
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#a0aec0] max-w-2xl mx-auto">
              Get fired up with Iron Mike&apos;s motivational messages to push
              through tough moments and build a championship mindset
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {motivateMessages.map((motivate) => (
              ...
              >
                ...
                <button
                  onClick={() =>
                    handleShare(motivate.content, motivate.shareTitle)
                  }
