        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#a0aec0] max-w-2xl mx-auto">
              The terms and conditions for using OnlyHockey services.
            </p>
          </div>
          ...
          <div className="bg-[#16213e] rounded-lg p-8 border border-[#2d3748]">
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-[#a0aec0] leading-relaxed mb-6">
                OnlyHockey provides shareable hockey content including factoids, statistics, motivational content, and digital products for hockey fans.
              </p>
              ...
              <ul className="text-[#a0aec0] leading-relaxed mb-6 space-y-2">
                <li><strong className="text-white">Our Content:</strong> All OnlyHockey content is protected by copyright and owned by us</li>
                ...
                <li><strong className="text-white">Prohibited Uses:</strong> No commercial redistribution, modification, or claiming ownership of our content</li>
              </ul>
              ...
              <ul className="text-[#a0aec0] leading-relaxed mb-6 space-y-2">
                ...
                <li>Refunds available within 30 days for unused digital products</li>
