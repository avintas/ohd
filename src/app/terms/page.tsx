          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="text-[#a0aec0] leading-relaxed space-y-2 list-disc list-inside">
                ...
                <li>
                  You must be 13 years or older to create an account (users
            ...
            <div>
              ...
              <ul className="text-[#a0aec0] leading-relaxed space-y-2 list-disc list-inside">
                <li>
                  <strong className="text-white">Our Content:</strong> All
                  OnlyHockey.com content is protected by copyright and is owned
                  by us.
                </li>
                <li>
                  <strong className="text-white">Your Use:</strong> You may
                  share our content for personal, non-commercial use with proper
                  attribution.
                </li>
                <li>
                  <strong className="text-white">Prohibited Uses:</strong> You
                  may not commercially redistribute, modify, or claim ownership
                  of our content.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-[#a0aec0] leading-relaxed">
                OnlyHockey.com&apos;s liability is limited to the amount you
                paid for our services in the past 12 months.
              </p>
            </div>
