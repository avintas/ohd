      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-[#16213e] rounded-2xl p-8 shadow-lg border border-[#2d3748] h-full flex flex-col relative overflow-hidden">
            {/* Card Front */}
            <div
              className={`transition-all duration-700 ${showResult ? 'opacity-0 scale-x-0' : 'opacity-100 scale-x-100'} flex flex-col h-full`}
            >
              {/* Header */}
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#a0aec0]">
                    Challenge your hockey knowledge
                  </p>
                </div>
              </div>
              ...
              <div className="flex-grow mb-6">
                <h4 className="text-lg font-semibold text-white mb-4">
                  Which Original Six team was the first to win the Stanley Cup
                  after the NHL expansion in 1967?
                </h4>
            ...
            {/* Card Back - Result */}
            <div
              className={`absolute inset-0 p-8 transition-all duration-700 ${showResult ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'} flex flex-col justify-center items-center text-center`}
            >
              {selectedAnswer === correctAnswer ? (
                // Correct Answer
                <>
                  <div className="text-8xl mb-4 animate-bounce">🎉</div>
                  <h3 className="text-3xl font-bold text-[#4cc9f0] mb-4">
                    Congratulations!
                  </h3>
                  <p className="text-xl text-white mb-2">You got it right!</p>
                  <p className="text-[#a0aec0] mb-6">
                    The Montreal Canadiens won the Stanley Cup in 1968, the
                    first Original Six team to do so after the 1967 expansion.
                  </p>
                ...
                <>
                  ...
                  <p className="text-[#a0aec0] mb-6">
                    The correct answer is Montreal Canadiens. They won in 1968,
                    becoming the first Original Six team to capture the Cup
                    after the expansion.
                  </p>
                  <div className="text-4xl mb-6">💪 🏒 📚</div>
                </>
            ...
            <div className="flex-grow mb-6">
              ...
              <div className="bg-[#0a0e1a] rounded-lg p-4 mb-4">
                <p className="text-[#a0aec0] leading-relaxed">
                  &quot;Hockey is for everyone - all backgrounds, all skill
                  levels, all ages. Let&apos;s make sure our rinks are welcoming
                  spaces where everyone feels they belong. Diversity makes our
                  sport stronger! 🏒&quot;
                </p>
              </div>
