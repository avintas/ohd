  ...
  return (
    <header className="w-full bg-[#0a0e1a] py-4 px-4 md:px-6 2xl:px-8">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          <span
            className={`block w-6 h-0.5 bg-[#a0aec0] transition-all duration-300 ${
        ...
        <nav
          className={`fixed top-0 right-0 h-full w-64 bg-[#0a0e1a] border-l border-[#4cc9f0] transform transition-transform duration-300 z-40 md:hidden ${
